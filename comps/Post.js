...
class Post extends React.Component {
  ...
  handleSelected=()=>{
    ...
    this.props.dispatch(SelectItem(this.props.postid, this.props.author, this.props.username,this.props.userimg, this.props.title, this.props.content, this.props.img, this.props.pickedComments, this.props.category, this.props.progress));
    //change page
